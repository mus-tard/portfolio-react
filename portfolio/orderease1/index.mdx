...
<SectionSummary
 ...
 />
Before I began as a web design and marketing intern and started their CMS redesign, the site was managed by a single person. Evidence for the benefits of user testing or design thinking had yet to be felt. Therefore their design strategy was to improve the website's aesthetics to increase its ability to generate leads. It was powered by an older HubSpot theme that was purchased years ago that was difficult to update. Outdated custom CSS also cause further design inconsistencies. Due to time and budget constraints, only the most practical and aesthetic-based design practices could be employed.
