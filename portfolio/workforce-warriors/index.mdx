...
<SectionSummary
 ...
 />
Workforce Warriors, an Indigenous non-profit, had Algonquin College students replace their outdated website with one that represented them better. A group of students in a previous semester created a design file in Adobe XD during a 10 week design process. It included a mockup of a four-page website and all the visual assets that were required. We work with three representitives from Workforce Warriors, and I lead a team of four other students. Our job was to develop a WordPress website based on the new design during our semester.
